...
export default function Writing() {
  return (
    <section
      id="projects"
      className="mb-2 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24"
            ...
            <div className="z-10 col-span-6">
              ...
              <h3 className="-mt-1">
                <a
                  ...
                  href="https://dev.to/alananayadev/using-chatgpt-to-optimize-code-in-xcode-a-new-era-of-development-1m19"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Using ChatGPT to Optimize Code in Xcode: A New Era of Development"
                >
                  <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                  <span>
                    Using ChatGPT to Optimize Code in Xcode: A New Era of{" "}
